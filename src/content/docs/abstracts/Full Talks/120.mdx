...
[1] DataPLANT. Nfdi4plants/ARC-Specification: Annotated Research Context Specification v3.0-draft.2. (Zenodo, 2025). doi:10.5281/ZENODO.15197625.

[2] Wilkinson, M. D. et al. The FAIR Guiding Principles for scientific data management and stewardship. Sci. Data 3, 160018 (2016).

[3] Johnson, D. et al. ISA API: An open platform for interoperable life science experimental metadata. Gigascience 10, (2021).

[4] Papoutsoglou, E. A. et al. Enabling reusability of plant phenomic datasets with MIAPPE 1.1. New Phytologist 227, 260–273 (2020).

[5] Soiland-Reyes, S. et al. Packaging research artefacts with RO-Crate. Data Sci. 5, 97–138 (2022).

[6] Weil, H. L. et al. PLANTdataHUB: a collaborative platform for continuous FAIR data sharing in plant research. The Plant Journal 116, 974–988 (2023).

[7] Nagel, L., & Lycklama, D. (2021). Design Principles for Data Spaces - Position Paper (1.0). Zenodo. doi:10.5281/zenodo.5105744

[8] Frey, K., Blume, P., Schneider, K. et al. Swate: Excel Add-In for Annotation of Experimental Data and Computational Workflows. (Github, 2020).

[9] Dumschott, K. et al. Ontologies for increasing the FAIRness of plant research data. Front. Plant Sci. 14, 1279694 (2023).
