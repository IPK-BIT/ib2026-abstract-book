...
<BookmarkButton
  id="/ib2026-abstract-book/abstracts/full-talks/110/"
  title={frontmatter.title}
  tagline={frontmatter.hero?.tagline}
  authors={frontmatter.authors}
/>
...
2.	The "Record": Retrospective provenance detailing when, by whom and with which specific parameters the workflow was executed, and which results were produced.

3.	Semantic Enrichment: Final outputs are linked to these metadata records using JSON-LD and Schema.org vocabularies, ensuring machine-interpretability.
